...
$colname_rsFOTOS = "1";
if (isset($_GET['URL_ALB_STATUS'])) {
  $colname_rsFOTOS = $_GET['URL_ALB_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsFOTOS = sprintf("SELECT * FROM tb_album WHERE ALB_STATUS = %s ORDER BY ALB_COD ASC", GetSQLValueString($colname_rsFOTOS, "int"));
$rsFOTOS = mysql_query($query_rsFOTOS, $conn92ID) or die(mysql_error());
$row_rsFOTOS = mysql_fetch_assoc($rsFOTOS);
$totalRows_rsFOTOS = mysql_num_rows($rsFOTOS);

mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_album where alb_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_album WHERE alb_status = 0";
...
<link href="css/colorbox.css" rel="stylesheet" type="text/css" />
		...
		<script>
			$(document).ready(function(){
				...
				$(".iframe").colorbox({iframe:true, width:"40%", height:"25%"});
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="/sgc/fotos-ins.php" title=""><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="fotos.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="fotos.php?URL_ALB_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><?php echo $row_rsFOTOS['ALB_COD']; ?></td>
              <td><a href="/sgc/fotos-edit.php?URL_ALB_COD=<?php echo $row_rsFOTOS['ALB_COD']; ?>"><?php echo $row_rsFOTOS['ALB_TITULO']; ?></a></td>
              <td><?php echo $row_rsFOTOS['ALB_DATA_DIA']; ?>/<?php echo $row_rsFOTOS['ALB_DATA_MES']; ?>/<?php echo $row_rsFOTOS['ALB_DATA_ANO']; ?></td>
              <td class="center"><?php echo $row_rsFOTOS['ALB_PICASA_USER']; ?></td>
              <td><a href="https://plus.google.com/photos/<?php echo $row_rsFOTOS['ALB_PICASA_USER']; ?>/albums/<?php echo $row_rsFOTOS['ALB_PICASA_ALBUM']; ?>?banner=pwa" target="_blank" title="Ver album no Picasa"><?php echo $row_rsFOTOS['ALB_PICASA_ALBUM']; ?>  <img src="images/icons/color/application-plus.png" alt="" width="16" height="16" /></a></td>
              <td class="center"><a href="/sgc/upload-resize.php?URL_FILENAME=<?php echo $row_rsFOTOS['ALB_COD']; ?>&amp;URL_DIR=fotos&amp;IMG_SIZE=700 x 350 pixel [JPG]" class="iframe"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /></a>
                <?php If (file_exists('../images/content/fotos/'.$row_rsFOTOS['ALB_COD'].'.jpg')) { ?>
                <a href="/images/content/fotos/<?php echo $row_rsFOTOS['ALB_COD']; ?>.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>
                <?php } ?></td>
              <td class="center"><?php $url_dis_status = isset( $_GET['URL_ALB_STATUS'] ) ? $_GET['URL_ALB_STATUS'] : null; ?>
                <?php
              switch ($url_dis_status) { 
			  case '0':
			  ?>
                <!-- ativa -->
                <a href="../_sgc_templates/active.php?URL_CHAVE=<?php echo $row_rsFOTOS['ALB_COD']; ?>&amp;URL_REDIR=fotos.php&amp;URL_TABLE=tb_album&amp;URL_PREFIX=ALB_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
                <?php 
			break;
			default: 
			?>
                <!-- desativa -->
                <a href="inactive.php?URL_CHAVE=<?php echo $row_rsFOTOS['ALB_COD']; ?>&amp;URL_REDIR=fotos.php&amp;URL_TABLE=tb_album&amp;URL_PREFIX=ALB_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
                <?php 
			  break;
			  } ?></td>
            </tr>
