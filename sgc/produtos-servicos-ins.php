...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_produtos_servicos (PRD_COD, POS_COD_HOME, POS_COD_CANAL, PRD_TITULO, PRD_CORPO, PRD_CORPO_HOME, PRD_FOTO_LEGENDA, PRD_STATUS, PRD_TAGS, PRDT_COD) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "produtos-servicos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="PRD_COD" id="PRD_COD" />
                  <div class="formRight"><input name="PRD_TITULO" type="text" id="PRD_TITULO"/></div><div class="fix"></div></div>
...
do {  
?>
                          <option value="<?php echo $row_rsPRODUTOS_SERVICOS['PRDT_COD']?>"><?php echo $row_rsPRODUTOS_SERVICOS['PRDT_NOME']?></option>
                          <?php
...
?>
                  ...
                  <div class="rowElem">
                    ...
                    <div class="formRight"><input name="PRD_FOTO_LEGENDA" type="text" id="PRD_FOTO_LEGENDA" /></div><div class="fix"></div></div>
                  <div class="rowElem">
                  <label>Tags:</label><div class="formRight"><input name="PRD_TAGS" type="text" id="PRD_TAGS" /></div><div class="fix"></div></div>
              
                        <div class="rowElem">
                          <label>Resumo:</label><div class="formRight"><textarea name="PRD_CORPO_HOME" cols="" rows="8" id="PRD_CORPO_HOME"></textarea></div><div class="fix"></div></div>
                        <div class="rowElem">
                        <label>Descri&ccedil;&atilde;o completa:</label><div class="formRight"><textarea name="PRD_CORPO" cols="" rows="5" class="wysiwyg" id="PRD_CORPO"></textarea></div><div class="fix"></div></div>
