...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_clientes (CLI_COD, CLI_NOME, CLI_RAMO, CLI_TAGS, CLI_STATUS, CLI_URL) VALUES (%s, %s, %s, %s, %s, %s)",
...
<title>Inserir &laquo; Clientes &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="CLI_COD" id="CLI_COD" />
                  <div class="formRight"><input name="CLI_NOME" type="text" id="CLI_NOME"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem nobg">
                  <label>Ramo:</label>
                  <div class="formRight"><input name="CLI_RAMO" type="text" id="CLI_RAMO"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                    <label>Website:</label>
                <div class="formRight">
                  <input name="CLI_URL" type="text" id="CLI_URL" value="" size="" />
                </div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                    <label>Tags:</label>
                <div class="formRight">
                  <input name="CLI_TAGS" type="text" id="CLI_TAGS" value="" size="" />
                </div><div class="fix"></div></div>
