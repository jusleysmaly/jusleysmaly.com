...
$query_rsNOTICIAS = sprintf("SELECT * FROM tb_materia WHERE MAT_STATUS = %s ORDER BY MAT_COD DESC", GetSQLValueString($colname_rsNOTICIAS, "int"));
$query_limit_rsNOTICIAS = sprintf("%s LIMIT %d, %d", $query_rsNOTICIAS, $startRow_rsNOTICIAS, $maxRows_rsNOTICIAS);
$rsNOTICIAS = mysql_query($query_limit_rsNOTICIAS, $conn92ID) or die(mysql_error());
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="noticias-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="noticias.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="noticias.php?URL_MAT_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="noticias-edit.php?URL_MAT_COD=<?php echo $row_rsNOTICIAS['MAT_COD']; ?>"><?php echo $row_rsNOTICIAS['MAT_COD']; ?> - <?php echo $row_rsNOTICIAS['MAT_TITULO']; ?></a></td>
              ...
              <td class="center">
              <a href="/sgc/upload-resize.php?URL_FILENAME=<?php echo $row_rsNOTICIAS['MAT_COD']; ?>&amp;URL_DIR=noticias&amp;IMG_SIZE=700 x 350 pixel [50% JPG]&amp;INAME=<?php echo $row_rsNOTICIAS['MAT_TITULO']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
			  
			  <?php If (file_exists('../images/content/noticias/'.$row_rsNOTICIAS['MAT_COD'].'.jpg')) { ?> <a href="/images/content/noticias/<?php echo $row_rsNOTICIAS['MAT_COD']; ?>.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?>
              ...
              <?php $url_dis_status = isset( $_GET['URL_MAT_STATUS'] ) ? $_GET['URL_MAT_STATUS'] : null; ?>
              <?php
              ...
              <!-- ativa -->
              <a href="../_sgc_templates/active.php?URL_CHAVE=<?php echo $row_rsNOTICIAS['MAT_COD']; ?>&amp;URL_REDIR=noticias.php&amp;URL_TABLE=tb_materia&amp;URL_PREFIX=MAT_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
			...
			?>
              ...
              <!-- desativa -->
              <a href="inactive.php?URL_CHAVE=<?php echo $row_rsNOTICIAS['MAT_COD']; ?>&amp;URL_REDIR=noticias.php&amp;URL_TABLE=tb_materia&amp;URL_PREFIX=MAT_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
