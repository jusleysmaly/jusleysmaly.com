...
$query_rsPRODUTOS_SERVICOS = "SELECT * FROM tb_produtos_servicos_categorias";
...
<link href="css/colorbox.css" rel="stylesheet" type="text/css" />
		...
		<script>
			$(document).ready(function(){
				...
				$(".iframe").colorbox({iframe:true, width:"400", height:"350"});
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="/sgc/produtos-servicos-categoria-ins.php" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="/sgc/produtos-servicos-categoria-edit.php?URL_PRDC_COD=<?php echo $row_rsPRODUTOS_SERVICOS['PRDC_COD']; ?>"><?php echo $row_rsPRODUTOS_SERVICOS['PRDC_COD']; ?> - <?php echo $row_rsPRODUTOS_SERVICOS['PRDC_NOME']; ?></a></td>
              <td><a href="/sgc/produtos-servicos-categoria-edit.php?URL_PRDC_COD=<?php echo $row_rsPRODUTOS_SERVICOS['PRDC_COD']; ?>"><?php echo $row_rsPRODUTOS_SERVICOS['PRDC_DESCRICAO']; ?></a></td>
              
              <!-- img -->
              <td><a href="/sgc/upload-multi.php?URL_FILENAME=<?php echo $row_rsPRODUTOS_SERVICOS['PRDC_COD']; ?>&amp;URL_DIR=produtos-servicos&amp;IMG_SIZE=800 x 530 pixel [JPG]" class="iframe"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /></a>
                <?php If (file_exists('../images/content/produtos-servicos/'.$row_rsPRODUTOS_SERVICOS['PRDC_COD'].'.jpg')) { ?>
                <a href="/images/content/produtos-servicos/<?php echo $row_rsPRODUTOS_SERVICOS['PRDC_COD']; ?>-cover.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>
              <?php } ?>
              
              <!-- verifica arquivo -->
              <?php If (file_exists('../images/content/produtos-servicos/'.$row_rsPRODUTOS_SERVICOS['PRDC_COD'].'-1.jpg')) { ?> <a href="/images/content/produtos-servicos/<?php echo $row_rsPRODUTOS_SERVICOS['PRDC_COD']; ?>-1.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?>
