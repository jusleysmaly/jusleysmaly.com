...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_produtos_servicos_subitens (PRDS_COD, PRDS_NOME, PRDS_DESCRICAO, PRD_COD, PRDS_STATUS, POS_COD_HOME) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "produtos-servicos-subitens.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="wrapper">
    ...
    <div class="content" id="container">
    	<div class="title">
    	  <h5>Subitens &laquo; Produtos e Servi&ccedil;os &laquo; Categorias &laquo; Inserir Novo</h5>
    	</div>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="PRDS_COD" id="PRDS_COD" />
                  <div class="formRight"><input name="PRDS_NOME" type="text" id="PRDS_NOME"/></div><div class="fix"></div></div>
...
do {  
?>
                          <option value="<?php echo $row_rsProdutosServicosTipos['PRD_COD']?>"><?php echo $row_rsProdutosServicosTipos['PRD_TITULO']?> « <?php echo $row_rsProdutosServicosTipos['PRDT_NOME']?></option>
                          <?php
...
?>
                  ...
                  <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="PRDS_DESCRICAO" cols="" rows="8" id="PRDS_DESCRICAO"></textarea></div><div class="fix"></div></div>
