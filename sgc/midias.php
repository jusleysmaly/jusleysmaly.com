...
$colname_rsMIDIAS = "1";
if (isset($_GET['URL_MID_STATUS'])) {
  $colname_rsMIDIAS = $_GET['URL_MID_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsMIDIAS = sprintf("SELECT * FROM vw_midias_tipo WHERE MID_STATUS = %s ORDER BY MID_COD DESC", GetSQLValueString($colname_rsMIDIAS, "int"));
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_midias where mid_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_midias WHERE mid_status = 0";
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iUser"><a href="midias.php?URL_MID_STATUS=0" title=""><span>Inativos</span></a></li>
        	<li class="iOrders"><a href="midias-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="midias.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="midias.php?URL_MID_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="midias-edit.php?URL_MID_COD=<?php echo $row_rsMIDIAS['MID_COD']; ?>"><?php echo $row_rsMIDIAS['MID_COD']; ?> - <?php echo $row_rsMIDIAS['MID_TITULO']; ?></a></td>
              <td class="center" ><strong><?php echo $row_rsMIDIAS['MIDT_NOME']; ?></strong></td>
              <td class="center" ><?php echo $row_rsMIDIAS['POS_COD_HOME']; ?></td>
              <td class="center"><?php echo $row_rsMIDIAS['POS_COD_CANAL']; ?></td>
              <td class="center">
              <a href="/sgc/upload-resize.php?URL_FILENAME=<?php echo $row_rsMIDIAS['MID_COD']; ?>&amp;URL_DIR=noticias&amp;IMG_SIZE=1140 x 705 pixel [PNG] [50% Qualidade]&amp;INAME=<?php echo $row_rsMIDIAS['MID_TITULO']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
			  
			  <?php If (file_exists('../images/content/midias/image1.jpg')) { ?> <a href="/images/content/midias/image1.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?></td>
              <td class="center"><a href="inactive.php?URL_CHAVE=<?php echo $row_rsMIDIAS['MID_COD']; ?>&amp;URL_REDIR=noticias.php&amp;URL_TABLE=tb_midias&amp;URL_PREFIX=MID_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a></td>
            </tr>
              <?php } while ($row_rsMIDIAS = mysql_fetch_assoc($rsMIDIAS)); ?>
          </tbody>
        </table>
      </div>
