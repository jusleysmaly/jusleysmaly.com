...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_equipe SET EQP_NOME=%s, EQP_SOBRENOME=%s, EQP_TELEFONE=%s, EQP_EMAIL=%s, EQP_FACEBOOK=%s, EQP_SITE=%s, EQP_SEXO=%s, EQP_STATUS=%s, EQP_CARGO=%s WHERE EQP_COD=%s",
                       GetSQLValueString($_POST['EQP_NOME'], "text"),
                       GetSQLValueString($_POST['EQP_SOBRENOME'], "text"),
                       GetSQLValueString($_POST['EQP_TELEFONE'], "text"),
                       GetSQLValueString($_POST['EQP_EMAIL'], "text"),
                       GetSQLValueString($_POST['EQP_FACEBOOK'], "text"),
                       GetSQLValueString($_POST['EQP_SITE'], "text"),
                       GetSQLValueString($_POST['EQP_SEXO'], "text"),
                       GetSQLValueString($_POST['EQP_STATUS'], "int"),
                       GetSQLValueString($_POST['EQP_CARGO'], "text"),
                       GetSQLValueString($_POST['EQP_COD'], "int"));

  mysql_select_db($database_conn92ID, $conn92ID);
  $Result1 = mysql_query($updateSQL, $conn92ID) or die(mysql_error());

  $updateGoTo = "equipe.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rsEquipe = "-1";
if (isset($_GET['URL_EQP_COD'])) {
  $colname_rsEquipe = $_GET['URL_EQP_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsEquipe = sprintf("SELECT * FROM tb_equipe WHERE EQP_COD = %s", GetSQLValueString($colname_rsEquipe, "int"));
$rsEquipe = mysql_query($query_rsEquipe, $conn92ID) or die(mysql_error());
...
<title>Editar &laquo; Parceiros &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
...
<div class="wrapper">
    ...
    <div class="leftNav">
    	<ul id="menu">
            ...
            <li class="dash"><a href="#" title="" class="exp"><span>Aeronaves</span><span class="numberLeft">2</span></a>
            	<ul class="sub">
                    <li><a href="/sgc/aeronaves.php" title="">Aeronaves</a></li>
                    <li><a href="/sgc/aeronaves-tipo.php" title="">Categorias</a></li>
                </ul>
            </li>
            ...
            <li class="dash"><a href="equipe.php?urlactive=08" title=""  ><span>Equipe</span></a></li>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="EQP_COD" type="hidden" id="EQP_COD" value="<?php echo $row_rsEquipe['EQP_COD']; ?>" />
                  <div class="formRight"><input name="EQP_NOME" type="text" id="EQP_NOME" value="<?php echo $row_rsEquipe['EQP_NOME']; ?>"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Sobrenome:</label>
                  <div class="formRight"><input name="EQP_SOBRENOME" type="text" id="EQP_SOBRENOME" value="<?php echo $row_rsEquipe['EQP_SOBRENOME']; ?>"/></div><div class="fix"></div></div>
                  
                   <div class="rowElem">
                  <label>Cargo:</label>
                  <div class="formRight"><input name="EQP_CARGO" type="text" id="EQP_CARGO" value="<?php echo $row_rsEquipe['EQP_CARGO']; ?>"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Telefone:</label>
                  <div class="formRight"><input name="EQP_TELEFONE" type="text" id="EQP_TELEFONE" value="<?php echo $row_rsEquipe['EQP_TELEFONE']; ?>"/></div><div class="fix"></div></div>
                  
                   <div class="rowElem">
                  <label>E-mai:</label>
                  <div class="formRight"><input name="EQP_EMAIL" type="text" id="EQP_EMAIL" value="<?php echo $row_rsEquipe['EQP_EMAIL']; ?>"/></div><div class="fix"></div></div>
                  
                  
                  <div class="rowElem">
                      <label>Status</label>
                        <div class="formRight">
                        <select name="EQP_STATUS" id="EQP_STATUS" >
                          <option value="0" <?php if (!(strcmp(0, $row_rsEquipe['EQP_STATUS']))) {echo "selected=\"selected\"";} ?>>0 - Inativa</option>
                          <option value="1" <?php if (!(strcmp(1, $row_rsEquipe['EQP_STATUS']))) {echo "selected=\"selected\"";} ?>>1 - Ativa</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                    </div>
                  ...
                  <div class="rowElem">
                      <label>Status</label>
                        <div class="formRight">
                        <select name="EQP_SEXO" id="EQP_SEXO" >
                          <option value="0" <?php if (!(strcmp(0, $row_rsEquipe['EQP_SEXO']))) {echo "selected=\"selected\"";} ?>>M - Masculino</option>
                          <option value="1" <?php if (!(strcmp(1, $row_rsEquipe['EQP_SEXO']))) {echo "selected=\"selected\"";} ?>>F - Feminino</option>
                        </select>
                      </div>
                        <div class="fix"></div>
                    </div>
                  ...
                  <div class="rowElem">
                    <label>Website:</label>
                <div class="formRight">
                  <input name="EQP_SITE" type="text" id="EQP_SITE" value="<?php echo $row_rsEquipe['EQP_SITE']; ?>" size="" />
                </div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                    <label>Facebook:</label>
                <div class="formRight">
                  <input name="EQP_FACEBOOK" type="text" id="EQP_FACEBOOK" value="<?php echo $row_rsEquipe['EQP_FACEBOOK']; ?>" size="" />
                </div><div class="fix"></div></div>
