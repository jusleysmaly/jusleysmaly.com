...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_midias_tipo SET MIDT_NOME=%s, MIDT_DESCRICAO=%s, MIDT_TAM1=%s, MIDT_TAM2=%s, MIDT_TAM3=%s WHERE MIDT_COD=%s",
                       GetSQLValueString($_POST['MIDT_NOME'], "text"),
                       GetSQLValueString($_POST['MIDT_DESCRICAO'], "text"),
                       GetSQLValueString($_POST['MIDT_TAM1'], "text"),
                       GetSQLValueString($_POST['MIDT_TAM2'], "text"),
                       GetSQLValueString($_POST['MIDT_TAM3'], "text"),
  ...
  $updateGoTo = "/sgc/midias-tipo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rsMIDIAS_TIPO = "-1";
if (isset($_GET['URL_MIDT_COD'])) {
  $colname_rsMIDIAS_TIPO = $_GET['URL_MIDT_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsMIDIAS_TIPO = sprintf("SELECT * FROM tb_midias_tipo WHERE MIDT_COD = %s", GetSQLValueString($colname_rsMIDIAS_TIPO, "int"));
...
<div class="wrapper">
    ...
    <div class="content" id="container">
    	<div class="title">
    	  <h5>M&iacute;dias &laquo; Categorias &laquo; Editar</h5>
    	</div>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="MIDT_COD" type="hidden" id="MIDT_COD" value="<?php echo $row_rsMIDIAS_TIPO['MIDT_COD']; ?>" />
                  <div class="formRight"><input name="MIDT_NOME" type="text" id="MIDT_NOME" value="<?php echo $row_rsMIDIAS_TIPO['MIDT_NOME']; ?>"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Tamanho #1:</label>
                  <div class="formRight"><input name="MIDT_TAM1" type="text" id="MIDT_TAM1" value="<?php echo $row_rsMIDIAS_TIPO['MIDT_TAM1']; ?>"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Tamanho #2:</label>
                  <div class="formRight"><input name="MIDT_TAM2" type="text" id="MIDT_TAM2" value="<?php echo $row_rsMIDIAS_TIPO['MIDT_TAM2']; ?>"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Tamanho #3:</label>
                  <div class="formRight"><input name="MIDT_TAM3" type="text" id="MIDT_TAM3" value="<?php echo $row_rsMIDIAS_TIPO['MIDT_TAM3']; ?>"/></div><div class="fix"></div></div>
                  
                  
                        <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="MIDT_DESCRICAO" cols="" rows="8" id="MIDT_DESCRICAO"><?php echo $row_rsMIDIAS_TIPO['MIDT_DESCRICAO']; ?></textarea></div><div class="fix"></div></div>
                        <input type="submit" value="Slvar Altera&ccedil;&otilde;es" class="basicBtn submitForm mb22" />
                        <div class="fix"></div>
