...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_produtos_servicos_tipo (PRDT_COD, PRDT_NOME, PRDT_DESCRICAO) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "produtos-servicos-tipo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="wrapper">
    ...
    <div class="content" id="container">
    	<div class="title">
    	  <h5>Produtos e Servi&ccedil;os &laquo; Categorias &laquo; Inserir Novo</h5>
    	</div>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="PRDT_COD" id="PRDT_COD" />
                  <div class="formRight"><input name="PRDT_NOME" type="text" id="PRDT_NOME"/></div><div class="fix"></div></div>
                        <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="PRDT_DESCRICAO" cols="" rows="8" id="PRDT_DESCRICAO"></textarea></div><div class="fix"></div></div>
