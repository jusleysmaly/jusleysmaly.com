...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_dicas_tipo (DICT_COD, DICT_NOME, DICT_DESCRICAO) VALUES (%s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="DICT_COD" id="DICT_COD" />
                  <div class="formRight"><input name="DICT_NOME" type="text" id="DICT_NOME"/></div><div class="fix"></div></div>
                        <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="DICT_DESCRICAO" cols="" rows="8" id="DICT_DESCRICAO"></textarea></div><div class="fix"></div></div>
