...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_equipe (EQP_COD, EQP_NOME, EQP_SOBRENOME, EQP_TELEFONE, EQP_EMAIL, EQP_FACEBOOK, EQP_SITE, EQP_SEXO, EQP_STATUS, EQP_CARGO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Inserir &laquo; Parceiros &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="EQP_COD" id="EQP_COD" />
                  <div class="formRight"><input name="EQP_NOME" type="text" id="EQP_NOME"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Sobrenome:</label>
                  <div class="formRight"><input name="EQP_SOBRENOME" type="text" id="EQP_SOBRENOME"/></div><div class="fix"></div></div>
                  
                  
                  <div class="rowElem">
                  <label>Cargo:</label>
                  <div class="formRight"><input name="EQP_CARGO" type="text" id="EQP_CARGO"/></div><div class="fix"></div></div>
                  
                  
                  <div class="rowElem">
                  <label>Telefone:</label>
                  <div class="formRight"><input name="EQP_TELEFONE" type="text" id="EQP_TELEFONE"/></div><div class="fix"></div></div>
                  
                   <div class="rowElem">
                  <label>E-mai:</label>
                  <div class="formRight"><input name="EQP_EMAIL" type="text" id="EQP_EMAIL"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                      <label>Status</label>
                        ...
                        <select name="EQP_SEXO" id="EQP_SEXO" >
                          <option value="0" selected="selected">M - Masculino</option>
                          <option value="1">F - Feminino</option>
                        </select>
                      </div>
                        <div class="fix"></div>
                    </div>
                  ...
                  <div class="rowElem">
                    <label>Website:</label>
                <div class="formRight">
                  <input name="EQP_SITE" type="text" id="EQP_SITE" value="" size="" />
                </div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                    <label>Facebook:</label>
                <div class="formRight">
                  <input name="EQP_FACEBOOK" type="text" id="EQP_FACEBOOK" value="" size="" />
                </div><div class="fix"></div></div>
