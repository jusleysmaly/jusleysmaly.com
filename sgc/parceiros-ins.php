...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_parceiros (PAR_COD, PAR_NOME, PAR_RAMO, PAR_TAGS, PAR_STATUS, PAR_URL) VALUES (%s, %s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="PAR_COD" id="PAR_COD" />
                  <div class="formRight"><input name="PAR_NOME" type="text" id="PAR_NOME"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem nobg">
                  <label>Ramo:</label>
                  <div class="formRight"><input name="PAR_RAMO" type="text" id="PAR_RAMO"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                    <label>Website:</label>
                <div class="formRight">
                  <input name="PAR_URL" type="text" id="PAR_URL" value="" size="" />
                </div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                    <label>Tags:</label>
                <div class="formRight">
                  <input name="PAR_TAGS" type="text" id="PAR_TAGS" value="" size="" />
                </div><div class="fix"></div></div>
