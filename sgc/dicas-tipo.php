...
$query_rsDICAS = "SELECT * FROM tb_dicas_tipo";
...
<title>Tipos de Dicas &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="/sgc/dicas-tipo-ins.php" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="/sgc/dicas-tipo-edit.php?URL_DICT_COD=<?php echo $row_rsDICAS['DICT_COD']; ?>"><?php echo $row_rsDICAS['DICT_COD']; ?> - <?php echo $row_rsDICAS['DICT_NOME']; ?></a></td>
              <td><a href="/sgc/dicas-tipo-edit.php?URL_DICT_COD=<?php echo $row_rsDICAS['DICT_COD']; ?>"><?php echo $row_rsDICAS['DICT_DESCRICAO']; ?></a></td>
            </tr>
