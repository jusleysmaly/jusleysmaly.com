...
$colname_rsFRASES = "1";
if (isset($_GET['URL_DEP_STATUS'])) {
  $colname_rsFRASES = $_GET['URL_DEP_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsFRASES = sprintf("SELECT * FROM tb_depoimentos WHERE DEP_STATUS = %s", GetSQLValueString($colname_rsFRASES, "int"));
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_depoimentos where dep_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_depoimentos WHERE dep_status = 0";
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="depoimentos-ins.php" title=""><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="depoimentos.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="depoimentos.php?URL_DEP_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
     ...
     <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="depoimentos-edit.php?URL_DEP_COD=<?php echo $row_rsFRASES['DEP_COD']; ?>"><?php echo $row_rsFRASES['DEP_CORPO']; ?></a></td>
              <td><?php echo $row_rsFRASES['DEP_CLIENTE']; ?></td>
              
              <td class="center">
                <a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsFRASES['DEP_COD']; ?>&amp;URL_DIR=depoimentos&amp;IMG_SIZE=500 x 500 pixel [JPG]&amp;INAME=<?php echo $row_rsFRASES['DEP_CLIENTE']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
                
                <?php If (file_exists('../images/content/depoimentos/'.$row_rsFRASES['DEP_COD'].'.jpg')) { ?> <a href="/images/content/depoimentos/<?php echo $row_rsFRASES['DEP_COD']; ?>.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?>
                
                
                
              </td>
              <td><span class="center">
              <?php $url_dis_status = isset( $_GET['URL_DEP_STATUS'] ) ? $_GET['URL_DEP_STATUS'] : null; ?>
              <?php
              switch ($url_dis_status) { 
			  case '0':
			  ?>
              <!-- ativa -->
              <a href="../_sgc_templates/active.php?URL_CHAVE=<?php echo $row_rsFRASES['DEP_COD']; ?>&amp;URL_REDIR=frases.php&amp;URL_TABLE=tb_depoimentos&amp;URL_PREFIX=DEP_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
              <?php 
			break;
			default: 
			?>
              <!-- desativa -->
              <a href="inactive.php?URL_CHAVE=<?php echo $row_rsFRASES['DEP_COD']; ?>&amp;URL_REDIR=frases.php&amp;URL_TABLE=tb_depoimentos&amp;URL_PREFIX=DEP_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
              <?php 
			  break;
			  } ?>
              </span></td>
