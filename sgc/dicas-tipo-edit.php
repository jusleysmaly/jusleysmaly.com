...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_dicas_tipo SET DICT_NOME=%s, DICT_DESCRICAO=%s WHERE DICT_COD=%s",
                       GetSQLValueString($_POST['DICT_NOME'], "text"),
                       GetSQLValueString($_POST['DICT_DESCRICAO'], "text"),
...
$colname_rsDICAS_TIPO = "-1";
if (isset($_GET['URL_DICT_COD'])) {
  $colname_rsDICAS_TIPO = $_GET['URL_DICT_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsDICAS_TIPO = sprintf("SELECT * FROM tb_dicas_tipo WHERE DICT_COD = %s", GetSQLValueString($colname_rsDICAS_TIPO, "int"));
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="DICT_COD" type="hidden" id="DICT_COD" value="<?php echo $row_rsDICAS_TIPO['DICT_COD']; ?>" />
                  <div class="formRight"><input name="DICT_NOME" type="text" id="DICT_NOME" value="<?php echo $row_rsDICAS_TIPO['DICT_NOME']; ?>"/></div><div class="fix"></div></div>
                        <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="DICT_DESCRICAO" cols="" rows="8" id="DICT_DESCRICAO"><?php echo $row_rsDICAS_TIPO['DICT_DESCRICAO']; ?></textarea>
