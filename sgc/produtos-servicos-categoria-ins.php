...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_produtos_servicos_categorias (PRDC_COD, PRDC_NOME, PRDC_DESCRICAO) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "produtos-servicos-categoria.php";
  if (isset($_SERVER['QUERY_STRING'])) {
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="PRDC_COD" id="PRDC_COD" />
                  <div class="formRight"><input name="PRDC_NOME" type="text" id="PRDC_NOME"/></div><div class="fix"></div></div>
                        <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="PRDC_DESCRICAO" cols="" rows="8" id="PRDC_DESCRICAO"></textarea></div><div class="fix"></div></div>
