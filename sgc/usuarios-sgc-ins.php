...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_usuario_sgc (USR_COD, USR_LOGIN, USR_PWD, USR_NOME, USR_PERMISSION, USR_DESC, USR_STATUS) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<title>Inserir Novo &laquo; Usu&aacute;rios SGC&laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="USR_COD" type="hidden" id="USR_COD" />
                  <div class="formRight"><input name="USR_NOME" type="text" id="USR_NOME"/></div><div class="fix"></div></div>
                  
                  
                  <div class="rowElem nobg">
                  <label>Descri&ccedil;&atilde;o:</label>
                  <input name="USR_COD" type="hidden" id="USR_COD" />
                  <div class="formRight"><input name="USR_DESC" type="text" id="USR_DESC"/></div><div class="fix"></div></div>
                        ...
                        <select name="USR_PERMISSION" id="USR_PERMISSION" >
                          ...
                          <option value="1">1 - Atualiza&ccedil;&atilde;o de Conte&uacute;do</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                    </div>
                  <div class="rowElem">
                    <label>Login:</label>
                    <div class="formRight"><input name="USR_LOGIN" type="text" id="USR_LOGIN"/></div><div class="fix"></div></div>
                  <div class="rowElem">
                  <label>Senha (M&aacute;x 8 caracteres):</label><div class="formRight"><input name="USR_PWD"class="validate[required,maxSize[8]]" type="text" id="USR_PWD" /></div><div class="fix"></div></div>
