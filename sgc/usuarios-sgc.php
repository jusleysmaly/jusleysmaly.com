...
if (isset($_GET['URL_USR_STATUS'])) {
  $colname_rsUSUARIO_SGC = $_GET['URL_USR_STATUS'];
}

mysql_select_db($database_conn92ID, $conn92ID);
$query_rsUSUARIO_SGC = sprintf("SELECT * FROM tb_usuario_sgc WHERE USR_STATUS = %s", GetSQLValueString($colname_rsUSUARIO_SGC, "int"));
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_usuario_sgc where usr_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_usuario_sgc WHERE usr_status = 0";
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iUser"><a href="usuarios-sgc.php?URL_USR_STATUS=0" title=""><span>Inativos</span></a></li>
        	<li class="iOrders"><a href="usuarios-sgc-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          ...
          <li class="last"><a href="usuarios-sgc.php?URL_USR_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="usuarios-sgc-edit.php?URL_USR_COD=<?php echo $row_rsUSUARIO_SGC['USR_COD']; ?>"><?php echo $row_rsUSUARIO_SGC['USR_COD']; ?> - <?php echo $row_rsUSUARIO_SGC['USR_NOME']; ?></a></td>
              <td><?php echo $row_rsUSUARIO_SGC['USR_PERMISSION']; ?></td>
              <td class="center" ><?php echo $row_rsUSUARIO_SGC['USR_DESC']; ?></td>
              <td class="center">
                <a href="/sgc/upload.php?URL_FILENAME=<?php echo $row_rsUSUARIO_SGC['USR_COD']; ?>&amp;URL_DIR=noticias" class="iframe"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
                
              <?php If (file_exists('../images/content/noticias/noticia1.jpg')) { ?> <a href="/images/content/noticias/noticia1.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?></td>
              <td class="center"><a href="inactive.php?URL_CHAVE=<?php echo $row_rsUSUARIO_SGC['USR_COD']; ?>&amp;URL_REDIR=usuarios-sgc.php&amp;URL_TABLE=tb_usuario_sgc&amp;URL_PREFIX=USR_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a></td>
            </tr>
