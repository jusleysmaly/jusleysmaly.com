...
$colname_rsVIDEOS = "1";
if (isset($_GET['URL_VID_COD'])) {
  $colname_rsVIDEOS = $_GET['URL_VID_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsVIDEOS = sprintf("SELECT * FROM tb_videos WHERE VID_COD = %s ORDER BY VID_COD ASC", GetSQLValueString($colname_rsVIDEOS, "int"));
$rsVIDEOS = mysql_query($query_rsVIDEOS, $conn92ID) or die(mysql_error());
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><?php echo $row_rsVIDEOS['VID_COD']; ?></td>
              <td><?php echo $row_rsVIDEOS['VID_NOME']; ?></td>
              <td><?php echo $row_rsVIDEOS['POS_COD_HOME']; ?></td>
              <td class="center"><?php echo $row_rsVIDEOS['POS_COD_CANAL']; ?></td>
