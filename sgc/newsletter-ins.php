...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_newsletter (NEW_COD, NEW_TITULO, NEW_CLIENTE, NEW_CORPO, NEW_STATUS, NEW_ADS_TITULO, NEW_ADS_CORPO, NEW_ADS_LINK) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                    <div class="head">
                  <h5 class="iList">Newsletter</h5></div>
                  ...
                  <div class="formRight"><input name="NEW_TITULO" type="text" id="NEW_TITULO"/></div><div class="fix"></div></div>
                        
                
                <div class="rowElem">
                <label>Link:</label>
                <input type="hidden" name="NEW_COD" id="NEW_COD" />
                
                <div class="formRight"><input name="NEW_CLIENTE" type="text" id="NEW_CLIENTE"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                  <label>Resumo:</label><div class="formRight"><textarea name="NEW_CORPO" cols="" rows="8" id="NEW_CORPO"></textarea></div><div class="fix"></div></div>
                  
                  <!-- Ads -->
                  
                 <div class="rowElem">
                  <label>Ads Titulo:</label>
                  <div class="formRight"><input name="NEW_ADS_TITULO" type="text" id="NEW_ADS_TITULO"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                  <label>Ads Texto:</label><div class="formRight"><textarea name="NEW_ADS_CORPO" cols="" rows="8" id="NEW_ADS_CORPO"></textarea></div><div class="fix"></div></div>
