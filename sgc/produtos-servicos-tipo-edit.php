...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_produtos_servicos_tipo SET PRDT_NOME=%s, PRDT_DESCRICAO=%s WHERE PRDT_COD=%s",
                       GetSQLValueString($_POST['PRDT_NOME'], "text"),
                       GetSQLValueString($_POST['PRDT_DESCRICAO'], "text"),
  ...
  $updateGoTo = "produtos-servicos-tipo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['URL_PRDT_COD'])) {
  $colname_rsPRODUTOS_SERVICOS_TIPO = $_GET['URL_PRDT_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsPRODUTOS_SERVICOS_TIPO = sprintf("SELECT * FROM tb_produtos_servicos_tipo WHERE PRDT_COD = %s", GetSQLValueString($colname_rsPRODUTOS_SERVICOS_TIPO, "int"));
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="PRDT_COD" type="hidden" id="PRDT_COD" value="<?php echo $row_rsPRODUTOS_SERVICOS_TIPO['PRDT_COD']; ?>" />
                  <div class="formRight"><input name="PRDT_NOME" type="text" id="PRDT_NOME" value="<?php echo $row_rsPRODUTOS_SERVICOS_TIPO['PRDT_NOME']; ?>"/></div><div class="fix"></div></div>
                        <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="PRDT_DESCRICAO" cols="" rows="8" id="PRDT_DESCRICAO"><?php echo $row_rsPRODUTOS_SERVICOS_TIPO['PRDT_DESCRICAO']; ?></textarea>
