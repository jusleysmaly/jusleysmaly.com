...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_agenda SET AGD_TITULO=%s, AGD_DESCRICAO=%s, AGD_DATA_DIA=%s, AGD_DATA_MES=%s, AGD_DATA_ANO=%s, AGD_LOCAL=%s, AGD_HORA=%s, AGD_STATUS=%s WHERE AGD_COD=%s",
                       GetSQLValueString($_POST['AGD_TITULO'], "text"),
                       GetSQLValueString($_POST['AGD_DESCRICAO'], "text"),
                       GetSQLValueString($_POST['AGD_DATA_DIA'], "int"),
                       GetSQLValueString($_POST['AGD_DATA_MES'], "int"),
                       GetSQLValueString($_POST['AGD_DATA_ANO'], "int"),
                       GetSQLValueString($_POST['AGD_LOCAL'], "text"),
                       GetSQLValueString($_POST['AGD_HORA'], "text"),
                       GetSQLValueString($_POST['AGD_STATUS'], "int"),
                       GetSQLValueString($_POST['AGD_COD'], "int"));
...
$colname_rsAGENDA = "-1";
if (isset($_GET['URL_AGD_COD'])) {
  $colname_rsAGENDA = $_GET['URL_AGD_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsAGENDA = sprintf("SELECT * FROM tb_agenda WHERE AGD_COD = %s", GetSQLValueString($colname_rsAGENDA, "int"));
$rsAGENDA = mysql_query($query_rsAGENDA, $conn92ID) or die(mysql_error());
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input name="AGD_COD" type="hidden" id="AGD_COD" value="<?php echo $row_rsAGENDA['AGD_COD']; ?>" />
                  <div class="formRight"><input name="AGD_TITULO" type="text" id="AGD_TITULO" value="<?php echo $row_rsAGENDA['AGD_TITULO']; ?>"/></div><div class="fix"></div></div>
                        
                        
                        <div class="rowElem nobg">
                        <label>Status</label>
                        <div class="formRight">
                        <select name="AGD_STATUS" id="AGD_STATUS" >
                          <option value="0" <?php if (!(strcmp(0, $row_rsAGENDA['AGD_STATUS']))) {echo "selected=\"selected\"";} ?>>0 - Inativa</option>
                          <option value="1" <?php if (!(strcmp(1, $row_rsAGENDA['AGD_STATUS']))) {echo "selected=\"selected\"";} ?>>1 - Ativa</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                    </div>
                    ...
                    <div class="rowElem">
                        ...
                        <div class="formRight moreFields onlyNums">
                            <ul>
                                <li><input type="text" name="AGD_DATA_DIA" maxlength="2" value=<?php echo $row_rsAGENDA['AGD_DATA_DIA']; ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="AGD_DATA_MES" maxlength="2" value=<?php echo $row_rsAGENDA['AGD_DATA_MES']; ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="AGD_DATA_ANO" maxlength="4" value=<?php echo $row_rsAGENDA['AGD_DATA_ANO']; ?> /></li>
                  ...
                  <div class="rowElem">
                    <label>Local</label>
                    <div class="formRight"><input name="AGD_LOCAL" type="text" id="AGD_LOCAL" placeholder="enter your placeholder text here" value="<?php echo $row_rsAGENDA['AGD_LOCAL']; ?>"/></div><div class="fix"></div></div>
                  <div class="rowElem">
                  <label>Hora:</label><div class="formRight"><input name="AGD_HORA" type="text" id="AGD_HORA" value="<?php echo $row_rsAGENDA['AGD_HORA']; ?>" /></div><div class="fix"></div></div>
                  <div class="rowElem">
                    <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="AGD_DESCRICAO" cols="" rows="8" id="AGD_DESCRICAO"><?php echo $row_rsAGENDA['AGD_DESCRICAO']; ?></textarea>
