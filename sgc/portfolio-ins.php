...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_portfolio (POR_COD, POS_COD_HOME, POS_COD_CANAL, POR_TITULO, POR_CORPO, POR_CORPO_HOME, POR_FOTO_LEGENDA, POR_STATUS, POR_TAGS, PRD_COD, CLI_COD) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="POR_COD" id="POR_COD" />
                  <div class="formRight"><input name="POR_TITULO" type="text" id="POR_TITULO"/></div><div class="fix"></div></div>
                        ...
                        <div class="formRight">
                            ...
                            <?php do { ?>
                              <option value="<?php echo $row_rsClientes['CLI_COD']; ?>"><?php echo $row_rsClientes['CLI_NOME']; ?></option>
                        ...
                        <div class="formRight">
                          ...
                          <select name="PRD_COD" id="PRD_COD" >
                              <?php do { ?>
                            <option value="<?php echo $row_rsProdutos_Servicos['PRD_COD']; ?>"><?php echo $row_rsProdutos_Servicos['PRD_TITULO']; ?></option>
                  ...
                  <div class="rowElem">
                    ...
                    <div class="formRight"><input name="POR_FOTO_LEGENDA" type="text" id="POR_FOTO_LEGENDA" /></div><div class="fix"></div></div>
                  <div class="rowElem">
                  <label>Tags:</label><div class="formRight"><input name="POR_TAGS" type="text" id="POR_TAGS" /></div><div class="fix"></div></div>
              
                        <div class="rowElem">
                          <label>Resumo:</label><div class="formRight"><textarea name="POR_CORPO_HOME" cols="" rows="8" id="POR_CORPO_HOME"></textarea></div><div class="fix"></div></div>
                        <div class="rowElem">
                        <label>Descri&ccedil;&atilde;o completa:</label><div class="formRight"><textarea name="POR_CORPO" cols="" rows="5" class="wysiwyg" id="POR_CORPO"></textarea></div><div class="fix"></div></div>
