...
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_parceiros where par_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_parceiros WHERE par_status = 0";
...
$colname_rsPARCEIROS = "1";
if (isset($_GET['URL_PAR_STATUS'])) {
  $colname_rsPARCEIROS = $_GET['URL_PAR_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsPARCEIROS = sprintf("SELECT * FROM tb_parceiros WHERE PAR_STATUS = %s ORDER BY PAR_COD ASC", GetSQLValueString($colname_rsPARCEIROS, "int"));
$rsPARCEIROS = mysql_query($query_rsPARCEIROS, $conn92ID) or die(mysql_error());
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iUser"><a href="parceiros.php?URL_PAR_STATUS=0" title=""><span>Inativos</span></a></li>
        	<li class="iOrders"><a href="parceiros-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="leftNav">
    	<ul id="menu">
        	...
        	<li class="dash"><a href="noticias.php?urlactive=02" title=""  ><span>Imprensa</span></a></li>
            
            
            <li class="dash"><a href="#" title="" class="exp"><span>Serviços/Produtos</span><span class="numberLeft">2</span></a>
            	<ul class="sub">
            ...
            <li class="dash"><a href="cases.php" title=""  ><span>Projetos</span></a></li>
            ...
            <li class="dash"><a href="lojas.php" title=""  ><span>Onde Estamos?</span></a></li>
            <li class="dash"><a href="parceiros.php" title=""  ><span>Parceiros</span></a></li>
            <li class="dash"><a href="publicidade.php" title=""  ><span>Publicidade/Links</span></a></li>
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          ...
          <li class="last"><a href="clientes.php?URL_PAR_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="parceiros-edit.php?URL_PAR_COD=<?php echo $row_rsPARCEIROS['PAR_COD']; ?>"><?php echo $row_rsPARCEIROS['PAR_COD']; ?> - <?php echo $row_rsPARCEIROS['PAR_NOME']; ?></a></td>
              <td class="center" ><?php echo $row_rsPARCEIROS['PAR_RAMO']; ?></td>
              <td class="center">
                <a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsPARCEIROS['PAR_COD']; ?>&amp;URL_DIR=parceiros&amp;IMG_SIZE=400 x 400 pixel [PNG]" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
                
              <?php If (file_exists('../images/content/parceiros/'.$row_rsPARCEIROS['PAR_COD'].'.png')) { ?> <a href="/images/content/parceiros/<?php echo $row_rsPARCEIROS['PAR_COD']; ?>.png" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?></td>
              <td class="center">
              
              
              
              
              <?php $url_dis_status = isset( $_GET['URL_PAR_STATUS'] ) ? $_GET['URL_PAR_STATUS'] : null; ?>
              <?php
              ...
              <!-- ativa -->
              <a href="active.php?URL_CHAVE=<?php echo $row_rsPARCEIROS['PAR_COD']; ?>&amp;URL_REDIR=clientes.php&amp;URL_TABLE=tb_parceiros&amp;URL_PREFIX=PAR_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
			...
			?>
              ...
              <!-- desativa -->
              <a href="inactive.php?URL_CHAVE=<?php echo $row_rsPARCEIROS['PAR_COD']; ?>&amp;URL_REDIR=clientes.php&amp;URL_TABLE=tb_parceiros&amp;URL_PREFIX=PAR_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
              ...
              <?php } while ($row_rsPARCEIROS = mysql_fetch_assoc($rsPARCEIROS)); ?>
          </tbody>
        </table>
      </div>
