...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_midias_tipo (MIDT_COD, MIDT_NOME, MIDT_DESCRICAO, MIDT_TAM1, MIDT_TAM2, MIDT_TAM3) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "/sgc/midias-tipo.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="wrapper">
    ...
    <div class="content" id="container">
    	<div class="title">
    	  <h5>M&iacute;dias &laquo; Categorias &laquo; Inserir Novo</h5>
    	</div>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="MIDT_COD" id="MIDT_COD" />
                  <div class="formRight"><input name="MIDT_NOME" type="text" id="MIDT_NOME"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Tamanho #1:</label>
                  <div class="formRight"><input name="MIDT_TAM1" type="text" id="MIDT_TAM1"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Tamanho #2:</label>
                  <div class="formRight"><input name="MIDT_TAM2" type="text" id="MIDT_TAM2"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                  <label>Tamanho #3:</label>
                  <div class="formRight"><input name="MIDT_TAM3" type="text" id="MIDT_TAM3"/></div><div class="fix"></div></div>
                  
                  
                  <div class="rowElem">
                  <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="MIDT_DESCRICAO" cols="" rows="8" id="MIDT_DESCRICAO"></textarea></div><div class="fix"></div></div>
