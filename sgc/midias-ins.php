...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_midias (MID_COD, MID_TITULO, MID_DESC, POS_COD_HOME, POS_COD_CANAL, MID_STATUS, MID_CODE_01, MID_CODE_02, MID_CODE_03, MID_TAGS, MIDT_COD) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="MID_COD" id="MID_COD" />
                  <div class="formRight"><input name="MID_TITULO" type="text" id="MID_TITULO"/></div><div class="fix"></div></div>
...
do {  
?>
                          <option value="<?php echo $row_rsMIDIAS_TIPO['MIDT_COD']?>"><?php echo $row_rsMIDIAS_TIPO['MIDT_NOME']?></option>
                          <?php
...
?>
                  ...
                  <div class="rowElem nobg">
                    ...
                    <div class="rowElem">
                  <label>Tags:</label><div class="formRight"><input name="MID_TAGS" type="text" id="MID_TAGS" /></div><div class="fix"></div></div>
              
              <div class="rowElem">
                          <label>Descri&ccedil;&atilde;o:</label>
                <div class="formRight"><textarea name="MID_DESC" cols="" rows="8" id="MID_DESC"></textarea></div><div class="fix"></div></div>
                          
                        <div class="rowElem">
                          <label>Code#01 (Home):</label><div class="formRight"><textarea name="MID_CODE_01" cols="" rows="8" id="MID_CODE_01"></textarea></div><div class="fix"></div></div>
                          
                          <div class="rowElem">
                  <label>Code#02 (Canal):</label><div class="formRight"><textarea name="MID_CODE_02" cols="" rows="8" id="MID_CODE_02"></textarea></div><div class="fix"></div></div>
                          
                          <div class="rowElem">
                  <label>Code#03 (Outros):</label><div class="formRight"><textarea name="MID_CODE_03" cols="" rows="8" id="MID_CODE_03"></textarea></div><div class="fix"></div></div>
