...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_album (ALB_COD, POS_COD_HOME, POS_COD_CANAL, ALB_TITULO, ALB_RESUMO, ALB_DESCRICAO, ALB_PICASA_USER, ALB_PICASA_ALBUM, ALB_DATA_DIA, ALB_DATA_MES, ALB_DATA_ANO, ALB_STATUS, ALB_TAGS) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Inserir Novo &laquo; &Aacute;lbum &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="ALB_COD" id="ALB_COD" />
                  <div class="formRight"><input name="ALB_TITULO" type="text" id="ALB_TITULO"/></div><div class="fix"></div></div>
                    ...
                    <div class="rowElem">
                        ...
                        <div class="formRight moreFields onlyNums">
                            <ul>
                                <li><input type="text" name="ALB_DATA_DIA" maxlength="2" value=<?php echo date("d") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="ALB_DATA_MES" maxlength="2" value=<?php echo date("m") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="ALB_DATA_ANO" maxlength="4" value=<?php echo date("Y") ?> /></li>
                  ...
                  <div class="rowElem">
                    ...
                    <div class="formRight"><input name="ALB_PICASA_USER" type="text" id="ALB_PICASA_USER" value="113562756948248602531" /></div><div class="fix"></div></div>
                  <div class="rowElem">
                  <label>Picasa Album:</label><div class="formRight"><input name="ALB_PICASA_ALBUM" type="text" id="ALB_PICASA_ALBUM" /></div><div class="fix"></div></div>
                        <div class="rowElem">
                  <label>Tags:</label><div class="formRight"><input name="ALB_TAGS" type="text" id="ALB_TAGS" /></div><div class="fix"></div></div>
              
                        <div class="rowElem">
                          <label>Resumo:</label><div class="formRight"><textarea name="ALB_RESUMO" cols="" rows="8" id="ALB_RESUMO"></textarea></div><div class="fix"></div></div>
                        <div class="rowElem">
                        <label>Corpo:</label><div class="formRight"><textarea name="ALB_DESCRICAO" cols="" rows="5" class="wysiwyg" id="ALB_DESCRICAO"></textarea></div><div class="fix"></div></div>
