...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_dicas (DIC_COD, POS_COD_HOME, POS_COD_CANAL, DIC_TITULO, DIC_CORPO, DIC_CORPO_HOME, DIC_FOTO_LEGENDA, DIC_STATUS, DIC_FONTE, DIC_TAGS, DIC_DATA_DIA, DIC_DATA_MES, DIC_DATA_ANO, DICT_COD) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="DIC_COD" id="DIC_COD" />
                  <div class="formRight"><input name="DIC_TITULO" type="text" id="DIC_TITULO"/></div><div class="fix"></div></div>
...
do {  
?>
                          <option value="<?php echo $row_rsDICAS_TIPO['DICT_COD']?>"><?php echo $row_rsDICAS_TIPO['DICT_NOME']?></option>
                          <?php
...
?>
                    ...
                    <div class="rowElem">
                        ...
                        <div class="formRight moreFields onlyNums">
                            <ul>
                                <li><input type="text" name="DIC_DATA_DIA" maxlength="2" value=<?php echo date("d") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="DIC_DATA_MES" maxlength="2" value=<?php echo date("m") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="DIC_DATA_ANO" maxlength="4" value=<?php echo date("Y") ?> /></li>
                        ...
                        <select name="POS_COD_HOME" id="POS_COD_HOME" >
                          <option value="0" selected="selected">0 - Não Entra</option>
                  ...
                  <div class="rowElem">
                    ...
                    <div class="formRight"><input name="DIC_FOTO_LEGENDA" type="text" id="DIC_FOTO_LEGENDA" /></div><div class="fix"></div></div>
                  <div class="rowElem">
                  <label>Fonte:</label><div class="formRight"><input name="DIC_FONTE" type="text" id="DIC_FONTE" /></div><div class="fix"></div></div>
                        <div class="rowElem">
                  <label>Tags:</label><div class="formRight"><input name="DIC_TAGS" type="text" id="DIC_TAGS" /></div><div class="fix"></div></div>
              
                        <div class="rowElem">
                          <label>Resumo:</label><div class="formRight"><textarea name="DIC_CORPO_HOME" cols="" rows="8" id="DIC_CORPO_HOME"></textarea></div><div class="fix"></div></div>
                        <div class="rowElem">
                        <label>Corpo:</label><div class="formRight"><textarea name="DIC_CORPO" cols="" rows="5" class="wysiwyg" id="DIC_CORPO"></textarea></div><div class="fix"></div></div>
