...
$colname_rsAGENDA = "1";
if (isset($_GET['URL_AGD_STATUS'])) {
  $colname_rsAGENDA = $_GET['URL_AGD_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsAGENDA = sprintf("SELECT * FROM tb_agenda WHERE AGD_STATUS = %s ORDER BY AGD_COD ASC", GetSQLValueString($colname_rsAGENDA, "int"));
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_agenda where agd_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_agenda WHERE agd_status = 0";
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="agenda-ins.php" title=""><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="agenda.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="agenda.php?URL_AGD_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
     ...
     <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="agenda-edit.php?URL_AGD_COD=<?php echo $row_rsAGENDA['AGD_COD']; ?>"><?php echo $row_rsAGENDA['AGD_TITULO']; ?></a></td>
              <td><?php echo $row_rsAGENDA['AGD_LOCAL']; ?></td>
              <td><?php echo $row_rsAGENDA['AGD_DATA_DIA']; ?>/<?php echo $row_rsAGENDA['AGD_DATA_MES']; ?>/<?php echo $row_rsAGENDA['AGD_DATA_ANO']; ?></td>
              <td class="center"><?php echo $row_rsAGENDA['AGD_HORA']; ?></td>
              <td class="center"><?php $url_dis_status = isset( $_GET['URL_AGD_STATUS'] ) ? $_GET['URL_AGD_STATUS'] : null; ?>
                <?php
              switch ($url_dis_status) { 
			  case '0':
			  ?>
                <!-- ativa -->
                <a href="../_sgc_templates/active.php?URL_CHAVE=<?php echo $row_rsAGENDA['AGD_COD']; ?>&amp;URL_REDIR=agenda.php&amp;URL_TABLE=tb_agenda&amp;URL_PREFIX=AGD_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
                <?php 
			break;
			default: 
			?>
                <!-- desativa -->
                <a href="inactive.php?URL_CHAVE=<?php echo $row_rsAGENDA['AGD_COD']; ?>&amp;URL_REDIR=agenda.php&amp;URL_TABLE=tb_agenda&amp;URL_PREFIX=AGD_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
              <?php 
			  break;
			  } ?></td>
            </tr>
