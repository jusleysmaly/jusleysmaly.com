...
$query_rsMIDIAS = "SELECT * FROM tb_midias_tipo";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_midias_tipo";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_midias_tipo";
...
<title>M&iacute;dias &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="/sgc/midias-tipo-ins.php" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      <div class="title">
        <h5>M&iacute;dias &laquo; Categorias</h5>
      </div>
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="/sgc/midias-tipo-edit.php?URL_MIDT_COD=<?php echo $row_rsMIDIAS['MIDT_COD']; ?>"><?php echo $row_rsMIDIAS['MIDT_COD']; ?> - <?php echo $row_rsMIDIAS['MIDT_NOME']; ?></a></td>
              <td><?php echo $row_rsMIDIAS['MIDT_DESCRICAO']; ?></td>
              <td class="center">
                <a href="/sgc/upload-resize.php?URL_FILENAME=<?php echo $row_rsMIDIAS['MAT_COD']; ?>&amp;URL_DIR=noticias&amp;IMG_SIZE=1140 x 705 pixel [PNG] [50% Qualidade]&amp;INAME=<?php echo $row_rsMIDIAS['MIDT_NOME']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
