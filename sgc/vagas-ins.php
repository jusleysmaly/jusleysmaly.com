...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_vagas (VAG_COD, POS_COD_HOME, POS_COD_CANAL, VAG_TITULO, VAG_CORPO, VAG_STATUS, VAG_DATA_DIA, VAG_DATA_MES, VAG_DATA_ANO, VAG_QUANTIDADE) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Inserir &laquo; Vagas &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="VAG_COD" id="VAG_COD" />
                  <div class="formRight"><input name="VAG_TITULO" type="text" id="VAG_TITULO"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem">
                        <label>Data:</label> 
                        <div class="formRight moreFields onlyNums">
                            <ul>
                                <li><input type="text" name="VAG_DATA_DIA" maxlength="2" value=<?php echo date("d") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="VAG_DATA_MES" maxlength="2" value=<?php echo date("m") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="VAG_DATA_ANO" maxlength="4" value=<?php echo date("Y") ?> /></li>
                  ...
                  <input type="hidden" name="VAG_COD" id="VAG_COD" />
                  <div class="formRight"><input name="VAG_QUANTIDADE" type="text" id="VAG_QUANTIDADE"/></div><div class="fix"></div></div>
                ...
                <div class="formRight"><textarea name="VAG_CORPO" cols="" rows="8" id="VAG_CORPO"></textarea></div><div class="fix"></div></div>
