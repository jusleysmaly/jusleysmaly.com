...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_materia SET POS_COD_HOME=%s, POS_COD_CANAL=%s, MAT_TITULO=%s, MAT_CORPO=%s, MAT_CORPO_HOME=%s, MAT_FOTO_LEGENDA=%s, MAT_STATUS=%s, MAT_FONTE=%s, MAT_TAGS=%s, MAT_DATA_DIA=%s, MAT_DATA_MES=%s, MAT_DATA_ANO=%s WHERE MAT_COD=%s",
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <div class="rowElem">
                    ...
                    <div class="formRight"><input name="MAT_FOTO_LEGENDA" type="text" id="MAT_FOTO_LEGENDA" value="<?php echo $row_rsMATERIA['MAT_FOTO_LEGENDA']; ?>"/></div><div class="fix"></div></div>
                  <div class="rowElem">
