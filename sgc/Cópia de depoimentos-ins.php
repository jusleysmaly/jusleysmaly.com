...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_depoimentos (DEP_COD, DEP_TITULO, DEP_CLIENTE, DEP_CORPO, DEP_STATUS) VALUES (%s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                    <div class="head">
                  <h5 class="iList">Frases</h5></div>
                        <div class="rowElem nobg">
                  <label>Autor:</label>
                  <input type="hidden" name="DEP_COD" id="DEP_COD" />
                  
                  <div class="formRight"><input name="DEP_CLIENTE" type="text" id="DEP_CLIENTE"/></div><div class="fix"></div></div>
                  
                  
                  <div class="rowElem nobg">
                  <label>Título:</label>
                  
                  <div class="formRight"><input name="DEP_TITULO" type="text" id="DEP_TITULO"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                  <label>Frase:</label><div class="formRight"><textarea name="DEP_CORPO" cols="" rows="8" id="DEP_CORPO"></textarea></div><div class="fix"></div></div>
