...
$arqfinal1 = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].'-1.jpg';
$arqfinal2 = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].'-2.jpg';
$arqfinal3 = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].'-3.jpg';
$arqfinal4 = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].'-4.jpg';
...
$filename4 = "../images/content/4".$_FILES['file']['name'];
...
<!-- Left navigation --><!-- Content -->
  <div class="content" id="container">
   	  <div class="title">
   	    <h5>Upload de Imagem de "<?php echo $_GET['INAME'] ?>"</h5></div>
    ...
    <form action="" class="mainForm" METHOD="POST" enctype="multipart/form-data">
          ...
          <fieldset>
              <div class="widget">    
                  ...
                  <div class="rowElem">
                    <div class="formRight">
                        <input type="file" class="fileInput" id="fileInput" name="file" />
