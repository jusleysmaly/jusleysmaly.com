...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_lojas SET LOJ_NOME=%s, LOJ_ENDERECO=%s, LOJ_LOC_LAT=%s, LOJ_LOC_LNG=%s, LOJ_STATUS=%s, LOJ_URL=%s, LOJ_TELEFONE=%s, LOJ_EMAIL=%s, LOJ_WHATS=%s, LOJ_FUNCIONAMENTO=%s WHERE LOJ_COD=%s",
                       GetSQLValueString($_POST['LOJ_NOME'], "text"),
                       GetSQLValueString($_POST['LOJ_ENDERECO'], "text"),
                       GetSQLValueString($_POST['LOJ_LOC_LAT'], "double"),
                       GetSQLValueString($_POST['LOJ_LOC_LNG'], "double"),
                       GetSQLValueString($_POST['LOJ_STATUS'], "int"),
                       GetSQLValueString($_POST['LOJ_URL'], "text"),
                       GetSQLValueString($_POST['LOJ_TELEFONE'], "text"),
                       GetSQLValueString($_POST['LOJ_EMAIL'], "text"),
                       GetSQLValueString($_POST['LOJ_WHATS'], "text"),
                       GetSQLValueString($_POST['LOJ_FUNCIONAMENTO'], "text"),
                       GetSQLValueString($_POST['LOJ_COD'], "int"));

  mysql_select_db($database_conn92ID, $conn92ID);
  $Result1 = mysql_query($updateSQL, $conn92ID) or die(mysql_error());

  $updateGoTo = "lojas.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rsLojas = "-1";
if (isset($_GET['URL_LOJ_COD'])) {
  $colname_rsLojas = $_GET['URL_LOJ_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsLojas = sprintf("SELECT * FROM tb_lojas WHERE LOJ_COD = %s", GetSQLValueString($colname_rsLojas, "int"));
...
<title>Editar &laquo; Lojas &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="LOJ_COD" type="hidden" id="LOJ_COD" value="<?php echo $row_rsLojas['LOJ_COD']; ?>" />
                  <div class="formRight"><input name="LOJ_NOME" type="text" id="LOJ_NOME" value="<?php echo $row_rsLojas['LOJ_NOME']; ?>"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                      <label>Status</label>
                        <div class="formRight">
                        <select name="LOJ_STATUS" id="LOJ_STATUS" >
                          <option value="0" <?php if (!(strcmp(0, $row_rsLojas['LOJ_STATUS']))) {echo "selected=\"selected\"";} ?>>0 - Inativa</option>
                          <option value="1" <?php if (!(strcmp(1, $row_rsLojas['LOJ_STATUS']))) {echo "selected=\"selected\"";} ?>>1 - Ativa</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                    </div>
                ...
                <div class="formRight">
                  <input name="LOJ_ENDERECO" type="text" id="LOJ_ENDERECO" value="<?php echo $row_rsLojas['LOJ_ENDERECO']; ?>" size="" />
                  ...
                  <div class="rowElem">
                        ...
                        <div class="formRight">
                            <div class="floatleft">
                              <input name="LOJ_LOC_LAT" type="text" id="LOJ_LOC_LAT" value="<?php echo $row_rsLojas['LOJ_LOC_LAT']; ?>" />
                            </div>
                            <div class="floatleft" style="margin-left: 20px;">
                              <input name="LOJ_LOC_LNG" type="text" id="LOJ_LOC_LNG" value="<?php echo $row_rsLojas['LOJ_LOC_LNG']; ?>" />
                            </div>
                  ...
                  <div class="formRight"><input name="LOJ_TELEFONE" type="text" id="LOJ_TELEFONE" value="<?php echo $row_rsLojas['LOJ_TELEFONE']; ?>"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem ">
                  <label>Email:</label>
                  <div class="formRight"><input name="LOJ_EMAIL" type="text" id="LOJ_EMAIL" value="<?php echo $row_rsLojas['LOJ_EMAIL']; ?>"/></div><div class="fix"></div></div>
                    
                  <div class="rowElem">
                    <label>WhatsApp:</label>
                <div class="formRight">
                  <input name="LOJ_WHATS" type="text" id="LOJ_WHATS" value="<?php echo $row_rsLojas['LOJ_WHATS']; ?>" size="" />
                </div><div class="fix"></div></div>
                
                <div class="rowElem">
                    <label>Foursquare/Gmaps Url:</label>
                <div class="formRight">
                  <input name="LOJ_URL" type="text" id="LOJ_URL" value="<?php echo $row_rsLojas['LOJ_URL']; ?>" size="" />
                </div><div class="fix"></div></div>
                ...
                <div class="formRight">
                  <input name="LOJ_FUNCIONAMENTO" type="text" id="LOJ_FUNCIONAMENTO" value="<?php echo $row_rsLojas['LOJ_FUNCIONAMENTO']; ?>" size="" />
                </div><div class="fix"></div></div>
