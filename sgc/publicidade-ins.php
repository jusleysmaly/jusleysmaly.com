...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_publicidade (PUB_COD, POS_COD_HOME, POS_COD_CANAL, PUB_TITULO, PUB_LINK, PUB_STATUS, PUB_DESC, PUB_TIPO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "/sgc/publicidade.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="wrapper">
    ...
    <div class="content" id="container">
    	<div class="title">
    	  <h5>Publicidade &laquo; Inserir Novo</h5></div>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="PUB_COD" id="PUB_COD" />
                  <div class="formRight"><input name="PUB_TITULO" type="text" id="PUB_TITULO"/></div><div class="fix"></div></div>
                        
                        
                        <div class="rowElem">
                    <label>URL:</label>
                    <div class="formRight"><input name="PUB_LINK" type="text" id="PUB_LINK"/></div><div class="fix"></div></div>
                    
                    
                    <div class="rowElem">
                    <label>Descri&ccedil;&atilde;o:</label>
                    <div class="formRight"><input name="PUB_DESC" type="text" id="PUB_DESC"/></div><div class="fix"></div></div>
