...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_agenda (AGD_COD, AGD_TITULO, AGD_DESCRICAO, AGD_DATA_DIA, AGD_DATA_MES, AGD_DATA_ANO, AGD_LOCAL, AGD_HORA, AGD_STATUS) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Título:</label>
                  <input type="hidden" name="AGD_COD" id="AGD_COD" />
                  <div class="formRight"><input name="AGD_TITULO" type="text" id="AGD_TITULO"/></div><div class="fix"></div></div>
                    ...
                    <div class="rowElem">
                        ...
                        <div class="formRight moreFields onlyNums">
                            <ul>
                                <li><input type="text" name="AGD_DATA_DIA" maxlength="2" value=<?php echo date("d") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="AGD_DATA_MES" maxlength="2" value=<?php echo date("m") ?> /></li>
                                <li class="sep">/</li>
                                <li><input type="text" name="AGD_DATA_ANO" maxlength="4" value=<?php echo date("Y") ?> /></li>
                  ...
                  <div class="rowElem">
                    <label>Local</label>
                    <div class="formRight"><input name="AGD_LOCAL" type="text" id="AGD_LOCAL" placeholder="enter your placeholder text here"/></div><div class="fix"></div></div>
                  <div class="rowElem">
                  <label>Hora:</label><div class="formRight"><input name="AGD_HORA" type="text" id="AGD_HORA" /></div><div class="fix"></div></div>
                  <div class="rowElem">
                    <label>Descri&ccedil;&atilde;o:</label><div class="formRight"><textarea name="AGD_DESCRICAO" cols="" rows="8" id="AGD_DESCRICAO"></textarea></div><div class="fix"></div></div>
