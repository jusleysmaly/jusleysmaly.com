...
<div class="wrapper">
    ...
    <div class="content" id="container">
    	<div class="title">
    	  <h5>Informa&ccedil;&otilde;es do CMS</h5></div>
        ...
        <form method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <div class="rowElem">
                  <label>Email de suporte:</label><div class="formRight"><input name="PRD_TAGS" type="text" id="PRD_TAGS" /></div><div class="fix"></div></div>
