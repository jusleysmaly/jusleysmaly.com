...
if (isset($_GET['URL_EQP_STATUS'])) {
  $colname_rsUSUARIO_SGC = $_GET['URL_EQP_STATUS'];
}

mysql_select_db($database_conn92ID, $conn92ID);
$query_rsUSUARIO_SGC = sprintf("SELECT * FROM tb_equipe WHERE EQP_STATUS = %s", GetSQLValueString($colname_rsUSUARIO_SGC, "int"));
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_equipe where eqp_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_equipe WHERE eqp_status = 0";
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iUser"><a href="usuarios-sgc.php?URL_EQP_STATUS=0" title=""><span>Inativos</span></a></li>
        	<li class="iOrders"><a href="equipe-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="usuarios-sgc.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="usuarios-sgc.php?URL_EQP_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="equipe-edit.php?URL_EQP_COD=<?php echo $row_rsUSUARIO_SGC['EQP_COD']; ?>"><?php echo $row_rsUSUARIO_SGC['EQP_COD']; ?> - <?php echo $row_rsUSUARIO_SGC['EQP_NOME']; ?> <?php echo $row_rsUSUARIO_SGC['EQP_SOBRENOME']; ?></a></td>
              <td><?php echo $row_rsUSUARIO_SGC['EQP_EMAIL']; ?></td>
              <td class="center" ><?php echo $row_rsUSUARIO_SGC['EQP_TELEFONE']; ?></td>
              
              
              <!-- img -->
              <td class="center"><a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsUSUARIO_SGC['EQP_COD']; ?>&amp;URL_DIR=equipe&amp;IMG_SIZE=500 x 500 pixel [JPG] [50% Qualidade]" class="iframe"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /></a>
                <?php If (file_exists('../images/content/equipe/'.$row_rsUSUARIO_SGC['EQP_COD'].'.jpg')) { ?>
                <a href="/images/content/equipe/<?php echo $row_rsUSUARIO_SGC['EQP_COD']; ?>.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>
              <?php } ?></td>
              <!-- end:img  -->
              
              
              <td class="center"><a href="inactive.php?URL_CHAVE=<?php echo $row_rsUSUARIO_SGC['EQP_COD']; ?>&amp;URL_REDIR=usuarios-sgc.php&amp;URL_TABLE=tb_equipe&amp;URL_PREFIX=EQP_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a></td>
            </tr>
              <?php } while ($row_rsUSUARIO_SGC = mysql_fetch_assoc($rsUSUARIO_SGC)); ?>
          </tbody>
        </table>
      </div>
