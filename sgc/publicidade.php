...
if (isset($_GET['URL_PUB_STATUS'])) {
  $colname_rsPUBLICIDADE = $_GET['URL_PUB_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsPUBLICIDADE = sprintf("SELECT * FROM tb_publicidade WHERE PUB_STATUS = %s", GetSQLValueString($colname_rsPUBLICIDADE, "int"));
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_publicidade where pub_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_publicidade WHERE pub_status = 0";
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="publicidade-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="publicidade.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="publicidade.php?URL_PUB_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="publicidade-edit.php?URL_PUB_COD=<?php echo $row_rsPUBLICIDADE['PUB_COD']; ?>"><?php echo $row_rsPUBLICIDADE['PUB_COD']; ?> - <?php echo $row_rsPUBLICIDADE['PUB_TITULO']; ?></a></td>
              <td class="center" >
              
              <?php
				switch ($row_rsPUBLICIDADE['PUB_TIPO']) {
					case 0:
						echo "Banner";
						break;
					case 1:
              ...
              <td class="center" ><?php echo $row_rsPUBLICIDADE['POS_COD_HOME']; ?></td>
              <td class="center"><?php echo $row_rsPUBLICIDADE['POS_COD_CANAL']; ?></td>
              <td class="center"><a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsPUBLICIDADE['PUB_COD']; ?>&amp;URL_DIR=publicidade&amp;IMG_SIZE=700 x 350 pixel [JPG]&amp;INAME=<?php echo $row_rsPUBLICIDADE['PUB_TITULO']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /></a>
                <?php If (file_exists('../images/content/publicidade/'.$row_rsPUBLICIDADE['PUB_COD'].'.jpg')) { ?>
                <a href="/images/content/publicidade/<?php echo $row_rsPUBLICIDADE['PUB_COD']; ?>.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>
              <?php } ?></td>
              <td class="center"><a href="inactive.php?URL_CHAVE=<?php echo $row_rsPUBLICIDADE['PUB_COD']; ?>&amp;URL_REDIR=publicidade.php&amp;URL_TABLE=tb_publicidade&amp;URL_PREFIX=PUB_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a></td>
            </tr>
