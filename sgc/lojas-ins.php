...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_lojas (LOJ_COD, LOJ_NOME, LOJ_ENDERECO, LOJ_LOC_LAT, LOJ_LOC_LNG, LOJ_STATUS, LOJ_URL, LOJ_TELEFONE, LOJ_EMAIL, LOJ_WHATS, LOJ_FUNCIONAMENTO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<title>Inserir &laquo; Lojas &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="LOJ_COD" id="LOJ_COD" />
                  <div class="formRight"><input name="LOJ_NOME" type="text" id="LOJ_NOME"/></div><div class="fix"></div></div>
                ...
                <div class="formRight">
                  <input name="LOJ_ENDERECO" type="text" id="LOJ_ENDERECO" value="" size="" />
                  ...
                  <div class="rowElem">
                        ...
                        <div class="formRight">
                            <div class="floatleft">
                              <input name="LOJ_LOC_LAT" type="text" id="LOJ_LOC_LAT" />
                            </div>
                            <div class="floatleft" style="margin-left: 20px;">
                              <input name="LOJ_LOC_LNG" type="text" id="LOJ_LOC_LNG" />
                            </div>
                  ...
                  <div class="formRight"><input name="LOJ_TELEFONE" type="text" id="LOJ_TELEFONE"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem ">
                  <label>Email:</label>
                  <div class="formRight"><input name="LOJ_EMAIL" type="text" id="LOJ_EMAIL"/></div><div class="fix"></div></div>
                    
                  <div class="rowElem">
                    <label>WhatsApp:</label>
                <div class="formRight">
                  <input name="LOJ_WHATS" type="text" id="LOJ_WHATS" value="" size="" />
                </div><div class="fix"></div></div>
                
                <div class="rowElem">
                    <label>Foursquare/Gmaps Url:</label>
                <div class="formRight">
                  <input name="LOJ_URL" type="text" id="LOJ_URL" value="" size="" />
                </div><div class="fix"></div></div>
                ...
                <div class="formRight">
                  <input name="LOJ_FUNCIONAMENTO" type="text" id="LOJ_FUNCIONAMENTO" value="" size="" />
                </div><div class="fix"></div></div>
