...
if (isset($_GET['URL_PRD_STATUS'])) {
  $colname_rsPRODUTOS_SERVICOS = $_GET['URL_PRD_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsPRODUTOS_SERVICOS = sprintf("SELECT * FROM vw_produtos_servicos_tipo WHERE PRD_STATUS = %s", GetSQLValueString($colname_rsPRODUTOS_SERVICOS, "int"));
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_produtos_servicos WHERE prd_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_produtos_servicos WHERE prd_status = 0";
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iOrders"><a href="produtos-servicos-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      <div class="title">
        <h5>Produtos e Servi&ccedil;os</h5>
      </div>
      <!-- Statistics -->
      <div class="stats">
        <ul>
      ...
      <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeA">
              <td><a href="produtos-servicos-edit.php?URL_PRD_COD=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>"><?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?> - <?php echo $row_rsPRODUTOS_SERVICOS['PRD_TITULO']; ?></a></td>
              <td><?php echo $row_rsPRODUTOS_SERVICOS['PRDT_NOME']; ?></td>
              <td class="center" ><?php echo $row_rsPRODUTOS_SERVICOS['POS_COD_HOME']; ?></td>
              <td class="center"><?php echo $row_rsPRODUTOS_SERVICOS['POS_COD_CANAL']; ?></td>
              <td class="center"><a href="../content/desconto-detail.php?URL_PRD_COD=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>" target="_blank"><img src="images/icons/color/external.png" width="16" height="16" /></a></td>
              
              <!-- cover -->
              <td class="center"><a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>-cover&amp;URL_DIR=produtos-servicos&amp;IMG_SIZE=1140 x 705 pixel [PNG] [50% Qualidade]&amp;INAME=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_TITULO']; ?>" target="_blank"> <img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /></a>
                <?php If (file_exists('../images/content/produtos-servicos/'.$row_rsPRODUTOS_SERVICOS['PRD_COD'].'-cover.png')) { ?>
                <a href="/images/content/produtos-servicos/<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>-cover.png" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>
              <?php } ?></td>
              <!-- end:cover -->
              
              <td class="center">
              <a href="/sgc/upload-multi.php?URL_FILENAME=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>&amp;URL_DIR=produtos-servicos&amp;IMG_SIZE=1140 x 705 pixel [JPG - Qualidade 50%]&amp;INAME=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_TITULO']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
			  
			  <?php If (file_exists('../images/content/produtos-servicos/'.$row_rsPRODUTOS_SERVICOS['PRD_COD'].'-1.jpg')) { ?> <a href="/images/content/produtos-servicos/<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>-1.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?>
              ...
              <?php $url_dis_status = isset( $_GET['URL_PRD_STATUS'] ) ? $_GET['URL_PRD_STATUS'] : null; ?>
              <?php
              ...
              <!-- ativa -->
              <a href="../_sgc_templates/active.php?URL_CHAVE=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>&amp;URL_REDIR=produtos-servicos.php&amp;URL_TABLE=tb_produtos_servicos&amp;URL_PREFIX=PRD_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
			...
			?>
              ...
              <!-- desativa -->
              <a href="inactive.php?URL_CHAVE=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>&amp;URL_REDIR=produtos-servicos.php&amp;URL_TABLE=tb_produtos_servicos&amp;URL_PREFIX=PRD_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
