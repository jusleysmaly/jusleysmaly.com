...
$arqfinal = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].".".$extension;
$arqfinal1 = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].'_01.'.$extension;
$arqfinal2 = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].'_02.'.$extension;
$arqfinal3 = "../images/content/".$_POST['edt-dir']."/".$_POST['edt-filename'].'_03.'.$extension;
...
<!-- Left navigation --><!-- Content -->
  <div class="content" id="container">
   	  <div class="title">
   	    <h5>Upload de Imagem para "<?php echo $_GET['INAME'] ?>"</h5></div>
