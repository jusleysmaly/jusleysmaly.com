...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_materia (MAT_COD, POS_COD_HOME, POS_COD_CANAL, MAT_TITULO, MAT_CORPO, MAT_CORPO_HOME, MAT_FOTO_LEGENDA, MAT_STATUS, MAT_FONTE, MAT_TAGS, MAT_DATA_DIA, MAT_DATA_MES, MAT_DATA_ANO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['MAT_COD'], "int"),
                       GetSQLValueString($_POST['POS_COD_HOME'], "int"),
                       GetSQLValueString($_POST['POS_COD_CANAL'], "int"),
                       GetSQLValueString($_POST['MAT_TITULO'], "text"),
                       GetSQLValueString($_POST['MAT_CORPO'], "text"),
                       GetSQLValueString($_POST['MAT_CORPO_HOME'], "text"),
                       GetSQLValueString($_POST['MAT_FOTO_LEGENDA'], "text"),
                       GetSQLValueString($_POST['MAT_STATUS'], "int"),
                       GetSQLValueString($_POST['MAT_FONTE'], "text"),
                       GetSQLValueString($_POST['MAT_TAGS'], "text"),
                       GetSQLValueString($_POST['MAT_DATA_DIA'], "int"),
                       GetSQLValueString($_POST['MAT_DATA_MES'], "int"),
                       GetSQLValueString($_POST['MAT_DATA_ANO'], "int"));

  mysql_select_db($database_conn92ID, $conn92ID);
  $Result1 = mysql_query($insertSQL, $conn92ID) or die(mysql_error());

  $insertGoTo = "/sgc/noticias.php";
  if (isset($_SERVER['QUERY_STRING'])) {
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <div class="rowElem">
                    ...
                    <div class="formRight"><input name="MAT_FOTO_LEGENDA" type="text" id="MAT_FOTO_LEGENDA" /></div><div class="fix"></div></div>
                  <div class="rowElem">
